...
Note different amplitude scale. Recommended acceleration is 5x better. More prominent difference in on X, on Y everything is too wobly on single rail. It is possible that with higher-quality rails difference would be less dramatic : 
